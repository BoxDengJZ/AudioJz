...
extension ObservableType {
    ...
    public func subscribe(onNext: ((Element) -> Void)?)
        -> Disposable {
            ...
            let onError: ((Swift.Error) -> Void)? = nil
            let onCompleted: (() -> Void)? = nil
            let onDisposed: (() -> Void)? = nil
    ...
    /**
     ...
     - returns: Subscription object used to unsubscribe from the observable sequence.
     */
    public func subscribeX(onNext: ((Element) -> Void)? = nil, onError: ((Swift.Error) -> Void)? = nil, onCompleted: (() -> Void)? = nil, onDisposed: (() -> Void)? = nil)
        -> Disposable {
            let disposable: Disposable
